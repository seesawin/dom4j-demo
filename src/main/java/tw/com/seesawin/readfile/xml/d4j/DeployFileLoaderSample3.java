...
public class DeployFileLoaderSample3 {

	public static void main(String[] args) throws DocumentException {
		// execute
		DeployFileLoaderSample3 sample = new DeployFileLoaderSample3();
...
//			System.out.println(element.getName());
		...
		for(Student s : studentList) {
			System.out.println("s : " + s.getFirstname());
			System.out.println("s : " + s.getLastname());
			System.out.println("s : " + s.getPid());
		}
	}
	...
	public void treeWalk(Document document) {
		...
		treeWalk(document.getRootElement(), "student", null);
	}
